<template>
  ...
  <div ref="rectangleContainer" class="flex flex-col items-center justify-end">
    ...
    >
      <div 
        ref="rectangle" 
        class="bg-[#E96228] opacity-85 transition-all duration-[3000ms] rounded-sm"
        :class="{
    ...
    <div class="mt-4">
      <img src="/src/assets/logos/skillslider/logo/html.svg" alt="Logo" class="w-7 h-7 mt-5
      md:w-9 md:h-9 
            ...
            setTimeout(() => {
              if (rectangle.value) {
                if (isSmallScreen.value) {
                  rectangle.value.style.height = "75%"; // Mobile height
                } else if (isMediumScreen.value) {
                  rectangle.value.style.height = "75%"; // Tablet height
                } else if (isLargeScreen.value) {
                  rectangle.value.style.height = "75%"; // Large screen height
                }
              }
            }, 300);
          }
