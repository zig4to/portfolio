<template>
  ...
  <div ref="rectangleContainer" class="flex flex-col items-center justify-end">
    ...
    >
      <div 
        ref="rectangle" 
        class="bg-[#EACD37] opacity-85 transition-all duration-[3000ms] rounded-sm"
        :class="{
    ...
    <div class="mt-4">
      <img src="/src/assets/logos/skillslider/javascript-white.svg" alt="Logo" class="w-7 h-7 mt-5
      md:w-9 md:h-9 
            ...
            setTimeout(() => {
              if (rectangle.value) {
                if (isSmallScreen.value) {
                  rectangle.value.style.height = "30%"; // Mobile height
                } else if (isMediumScreen.value) {
                  rectangle.value.style.height = "30%"; // Tablet height
                } else if (isLargeScreen.value) {
                  rectangle.value.style.height = "30%"; // Large screen height
                }
              }
            }, 1200);
          }
